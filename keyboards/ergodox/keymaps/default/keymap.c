...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        LT(SYMB,KC_NO), KC_TRNS,    KC_LALT, KC_LGUI,KC_TRNS,
                                               KC_PGUP,       KC_PGDN,
                                                              KC_HOME,
        ...
        KC_BSLS,     KC_N,   KC_M,   KC_COMM,KC_DOT,  KC_SLSH,       KC_RSFT,
                             KC_MINS,KC_EQL, KC_LBRC, KC_RBRC,       MEH_T(KC_NO),
        KC_LEFT, KC_RGHT,
        KC_UP,
        KC_DOWN, KC_FN1, KC_SPC
    ),
 ...
 * | LShift |   %  |   ^  |   [  |   ]  |   ~  |      |           |      |      |   [  |   ]  |   ~  |   \  |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      | Left | Alt  | Cmd  |  Up  |                                       | Left | Right| Down |  Up  | F12  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |      |      |
 *                                 ,------|------|------|       |------+------+------.
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_LEFT,KC_LALT,KC_LGUI,KC_UP,
                                       KC_TRNS,KC_TRNS,
                                               KC_TRNS,
                               KC_TRNS,KC_TRNS,KC_TRNS,
       // right hand
       KC_TRNS, KC_F6,   KC_F7,  KC_F8,   KC_F9,   KC_F10,  KC_F11,
       KC_TRNS, KC_TRNS, KC_LCBR,KC_RCBR, KC_PIPE, KC_ASTR, KC_TRNS,
                KC_TRNS, KC_LPRN,KC_RPRN, KC_GRV,  KC_PLUS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_LBRC,KC_RBRC, KC_TILD, KC_BSLS, KC_TRNS,
                         KC_LEFT,KC_RGHT, KC_DOWN, KC_UP,   KC_F12,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
),
